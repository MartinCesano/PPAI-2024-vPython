...
class TestGestorGenerarReporteRankingVino(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.region_vitivinicola = RegionVitivinicola("Mendoza", "Argentina")
    ...
    def test_buscarVinosConResenasPorTipoYFecha(self):
        ...
        # Crear instancia de GestorGenerarReporteRankingVino
        gestor = GestorGenerarReporteRankingVino()
        ...
        for vino in vinos_filtrados:
            self.assertTrue(vino.obtenerResenas(fecha_inicio, fecha_fin))
